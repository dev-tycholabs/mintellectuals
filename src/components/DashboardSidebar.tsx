...
export default function DashboardSidebar({ isExpert }: { isExpert: boolean }) {
    ...
    return (
        <aside className="fixed top-[73px] left-0 bottom-0 w-64 bg-[var(--bg-primary)]/80 backdrop-blur-lg border-r border-[var(--border-color)] z-40 flex flex-col">
                    ...
                    return (
                        <Link
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${isActive
                                ...
                                : "text-secondary hover:bg-[var(--bg-card)] hover:text-primary border border-transparent"
                                }`}
                        >
                            {item.icon}
                            {item.label}
