...
export default function SignupPage() {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center px-6 py-12 overflow-hidden">
            ...
            <div className="floating-orb w-80 h-80 bg-cyan-500 bottom-10 -left-40" style={{ animationDelay: "2s" }} />
            <div className="floating-orb w-64 h-64 bg-pink-500 top-1/3 right-1/4" style={{ animationDelay: "4s" }} />
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="glass-card p-8 md:p-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="signup-email" className="block text-sm font-medium text-secondary mb-1.5">
                                Email
                            </label>
                            <input
                                id="signup-email"
                        ...
                        <div>
                            <label htmlFor="signup-password" className="block text-sm font-medium text-secondary mb-1.5">
                                Password
                            </label>
                        ...
                        <p className="text-xs text-muted text-center leading-relaxed">
                            ...
                            <Link href="/terms" className="text-[#667eea] hover:text-[#764ba2] transition-colors">Terms</Link>
                            {" "}and{" "}
                            <Link href="/privacy" className="text-[#667eea] hover:text-[#764ba2] transition-colors">Privacy Policy</Link>
                        </p>
                    </form>
                    ...
                    <p className="text-center text-sm text-muted mt-6">
                        ...
                        <Link href="/login" className="text-[#667eea] hover:text-[#764ba2] transition-colors font-medium">
                            Sign in
                        </Link>
                    </p>
                </div>
